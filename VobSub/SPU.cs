...
namespace SubtitleParser.VobSub
{
    ...
    public class SPU
    {
        ...
        //    public SPU(byte[] data)
        //    {
        //        _data = data;
        //        _startDisplayControlSequenceTableAddress = Utils.GetEndianWord(_data, 2);
        //        ParseDisplayControlCommands(true, null, new List<Color>() { Color.Transparent, Color.Black, Color.Black, Color.Green }, false, false);
        //    }
        ...
        //    public SPU(byte[] data, int startDisplayControlSequenceTableAddress, int pixelDataAddressOffset)
        //    {
        //        _data = data;
        ...
        //        {
        //            int delayBeforeExecute = Utils.GetEndianWord(_data, displayControlSequenceTableAddress + _pixelDataAddressOffset);
        ...
        //            while (command != (int)DCC.End && numberOfCommands < 1000 && commandIndex < _data.Length)
        //            {
        //                numberOfCommands++;
        //                switch (command)
        //                {
        //                    case (int)DCC.ForcedStartDisplay: // 0
        //                        Forced = true;
        //                        commandIndex++;
        //                        break;
        //                    case (int)DCC.StartDisplay: // 1
        //                        commandIndex++;
        //                        break;
        //                    case (int)DCC.StopDisplay: // 2
        ...
        //                        commandIndex += 7;
        //                        break;
        //                    case (int)DCC.SetPixelDataAddress: // 6
        //                        imageTopFieldDataAddress = Utils.GetEndianWord(_data, commandIndex + 1) + _pixelDataAddressOffset;
        //                        imageBottomFieldDataAddress = Utils.GetEndianWord(_data, commandIndex + 3) + _pixelDataAddressOffset;
        //                        commandIndex += 5;
        //                        break;
        //                    case (int)DCC.ChangeColorAndContrast: // 7
        //                        commandIndex++;
        ...
        //            {
        //                displayControlSequenceTableAddress = Utils.GetEndianWord(_data, commandIndex + 3);
        //            }
        //            else
        //            {
        //                displayControlSequenceTableAddress = Utils.GetEndianWord(_data, displayControlSequenceTableAddress + 2);
        //            }
        //        }
        ...
        //            gr.Dispose();
        //        }
        //        var fastBmp = new FastBitmapA(bmp);
        //        fastBmp.LockImage();
        ...
        //    private static Bitmap CropBitmapAndUnlock(FastBitmapA bmp, Color backgroundColor, bool crop)
        //    {
        //        int y = 0;
        ...
        //    public static void GenerateBitmap(byte[] data, FastBitmapA bmp, int startY, int dataAddress, List<Color> fourColors, int addY)
        //    {
        //        int index = 0;
        //        bool onlyHalf = false;
        //        int y = startY;
        ...
        //    private void ParseDCSQT()
        //    {
        //        var startPos = Utils.GetEndianWord(_data, 2);
        //        var pos = startPos;
        //        var spbItem = new SubDispItem();
        //        var isLast = false;
        //        while (pos < _data.Length && isLast)
        //        {
        //            var delay = _data[pos];
        //            var tpDelay = TimeSpan.FromMilliseconds((delay << 10) / 90.0);
        //            pos+=2;
        //            //var nxtDCSQ = _data 


        //        }
        //        var _next = Utils.GetEndianWord(_data, 2);
        ...
        public class FourColor
        {
            ...
            public Color Emphasis1 { get; set; }
